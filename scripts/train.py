...
if __name__=="__main__":
    ...
    parser.add_argument('--out_dir', type=str, default='./models/model', help='directory where data is saved')
    parser.add_argument('--model_name', type=str, default='CNN', help='Model associated to the model builded')
    parser.add_argument('--front_end', type=str, default='VGG4L', choices = ['VGG3L','VGG4L', 'RepVGG4L'], help='Kind of Front-end Used')
